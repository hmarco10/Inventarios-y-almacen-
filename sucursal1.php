         ...
         <div style="background:<?php echo COLOR;?>;">  
             <div class="panel panel-info">
                <div class="panel-heading">
                    <h3>Editar foto de la sucursal:</h3>
		</div>        
            </div>  
         <?php
print"<form style='color:black;' class=\"form-horizontal form-label-left\" action=\"sucursal3.php\" enctype=\"multipart/form-data\"  method=\"POST\">";
?>
