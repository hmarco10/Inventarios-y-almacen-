...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-05-2021 a las 17:07:37
...
(290, 'Byron Castillo Casasola', '135', '3915', 'Unidad de Recursos Humanos', 1, '2021-03-30 14:20:18', '14514787885', '0', '', 'Peru', '', '', '', '', 1, 1, 0, '0.00', '0.00', '14514787885'),
...
(2886, 100, '1', '2020-12-31', '2021-01-31', '1', '', 'AGUA PURA');
...
(1, 'factura', 0, '124', '0', '0', '0', '0', '0', 'F001', 'F002', 'F003', 'F004', 'F005', 'F006'),
...
--
ALTER TABLE `consultas`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2887;
--
...
--
ALTER TABLE `saldos`
  MODIFY `id_saldo` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
--
...
--
ALTER TABLE `tmp`
  MODIFY `id_tmp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4108;
--
