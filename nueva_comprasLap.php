      ...
      <div class="right_col" role="main">
		...
		?>
                <div class="row" style='color:black;'>
                    ...
                    <div class="col-md-5 col-sm-5 col-xs-12" style="border-top:3px dotted yellow; border-bottom:3px dotted yellow; border-left:3px dotted yellow; border-right: 3px dotted yellow; background: white">
			...
			<form method="post" class="form-horizontal" role="form" id="datos_factura" action="actualizar.php">
				 <div style="background:orange;padding:5px;margin:5px;border-radius: 7px;">
				  ...
				  <div class="col-md-12 col-sm-12 col-xs-12">
                                      Proveedor
					  <input autocomplete="off" class="textfield10" type="text" style="background-color: white" class="form-control input-sm" id="nombre_proveedores" placeholder="Selecciona un proveedor" value="<?php echo $nombre;?>" <?php echo $read;?> required>
           ...
           <div>
            ...
            <table >
              ...
              <?php date_default_timezone_set('America/Lima');?>
                                ...
                                <input class="form-control input-sm" type="date" id="fecha" value="<?php echo date("Y-m-d");?>" required>
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12" style="width:50%">  
                                  <table>
                                    ...
                                    <tr>
                                      ...
                                      <td><input  class="textfield10"  name="fecha_fac"  data-validate-length-range="4" type="date"  class="col-md-6 col-sm-6 col-xs-12" style="float: left; width:80%;" id="fecha_fac"   value="<?php echo $fecha1;?>" required></td>                                   
                                    </tr>
                                   </table>
                                </div>
                            ...
                            <div class="form-group row">
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-md-8 col-sm-6 col-xs-12">
                                  <br>
                                    <h5 style="font-weight:bold;">Seleccione los programas que necesite: </h5>
                                </div>
                                <br>
...
<!-- <script src="//code.jquery.com/jquery-1.11.2.min.js"></script>
  ...
  <script>
	...
	$("#nombre_proveedores" ).on( "keydown", function( event ) {
        ...
        $(document).ready(function(){
			load(1);
                         $( "#resultados" ).load( "ajax/agregar_comprasLap.php" );
		});
                ...
                function agregar2 (id)
		{
			...
			$.ajax({
        type: "POST",
        url: "./ajax/agregar_comprasLap.php",
        data: "id="+id+"&precio_venta="+precio_venta+"&cantidad="+cantidad+"&stock="+stock+"&code="+code+"&lote="+lote+"&code2="+code2,
		 beforeSend: function(objeto){
