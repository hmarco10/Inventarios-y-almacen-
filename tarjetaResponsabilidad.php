...
url: "search_tarjetas.php",//la url adonde se va a mandar la cadena a buscar
data: dataString,
cache: false,
...
<body class="nav-md">
    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main">
		...
		?>  
                    ...
                    <form class="form-horizontal" role="form" id="datos_factura" action="listaTarjetas.php" method="get">
  ...
  <script type="text/javascript" src="js/VentanaCentrada.js"></script>
	...
	$("#nombre_cliente" ).on( "keydown", function( event ) {
	   ...
	   $(document).ready(function(){
			load(1);
                        $( "#resultados" ).load( "ajax/agregar_tarjetas.php" );
		});
    ...
    function agregar2 (id)
      ...
      //Inicia validacion
        ...
        type: "POST",
        url: "./ajax/agregar_tarjetas.php",
        data: "id="+id+"&precio_venta="+precio_venta+"&cantidad="+cantidad+"&stock="+stock+"&lote="+lote+"&estado="+estadoProducto,
		 beforeSend: function(objeto){
			$("#resultados").html("Mensaje: Cargando...");
		  },
        success: function(datos){
