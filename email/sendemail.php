<!--Author: Hugo Marco Vásquez
Author URL: http://cna.gob.gt
...
function sendemail($mail_username,$mail_userpassword,$mail_setFromEmail,$mail_setFromName,$mail_addAddress,$txt_message,$mail_subject, $template){
	require 'PHPMailer/PHPMailerAutoload.php';
       // $mail->SMTPDebug = 2; // COMENTADO EN desarrollo tira error puede servir para algo en produccion 
	$mail = new PHPMailer;
	...
	if(!$mail->send()) {
		...
		echo '<h1 style="color:green">Tu mensaje ha sido enviado!</h1>';
	}
}
?>