    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main">
		...
		<div class="panel-heading">
         ...
         <?php      
print"<form class=\"form-horizontal form-label-left\" action=\"fot4.php\" enctype=\"multipart/form-data\"  method=\"POST\">";
...
?>
				...
				<div class="col-sm-8">
                                    <select class="form-control" name="asignado" id="asignado">
                                        ...
                                        <option value="s1">Slider1 825x400</option>
                                        <option value="s5">Slider2 825x400</option>
                                        <option value="si1">Slider3 187x442</option>
                                        <option value="si5">Slider4 256x355</option>
                                         <option value="banner1">Banner1 653x288</option>
                                         <option value="banner2">Banner2 460x289</option>
                                         <option value="banner3">Banner3 1142x196</option>
                          ...
                          <div class="form-group">
				<label  class="col-sm-3 control-label">Comentario 1:</label>
				<div class="col-sm-8">
                                    
                                    <input type="text"  class="form-control" id="comentario1" name="comentario1" >
				</div>
			  </div>
              
                          <div class="form-group">
				<label  class="col-sm-3 control-label">Comentario 2:</label>
				<div class="col-sm-8">
                                    
                                    <input type="text"  class="form-control" id="comentario2" name="comentario2" >
				</div>
			  </div>
                          
                          <div class="form-group">
				<label  class="col-sm-3 control-label">Comentario 3:</label>
				<div class="col-sm-8">
                                    
                                    <input type="text"  class="form-control" id="comentario3" name="comentario3" >
				</div>
			  </div>
...
while ($row = mysqli_fetch_array($result3)) {
    ...
    ?>
       <tr id="valor1">
                       <td class=" "><img src="galeria1/<?php echo $archivo;?>" width="150" height="100"></td>
                       <td class=" "><?php echo $foto;?></td>
                        <td class=" "><?php echo $comentario1;?></td>
                        <td class=" "><?php echo $comentario2;?></td>
                        <td class=" "><?php echo $comentario3;?></td>
                        <td class=" "><?php echo $ubi_pag;?></td>
                        <td class=" "><a href="fot4.php?a=<?php echo $archivo;?>">Borrar Foto</a></td>
       </tr>
<?php
}                            
?>
