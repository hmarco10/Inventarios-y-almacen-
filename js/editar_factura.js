	...
	function agregar (id)
              ...
              function agregar1 (id1)
		{
			...
			{
			alert('Esto no es un numero');
			document.getElementById('cantidada'+id1).focus();
			return false;
			}                     
                	if (isNaN(precio_venta))
			{
