...
//if($tienda1==$tienda2){
    ?>   
<page backtop="15mm" backbottom="15mm" backleft="5mm" backright="5mm" style="font-size: 9pt; font-family: arial" >
        <page_footer>
    ...
    <table cellspacing="0" style="width: 100%; border: 0px solid black; font-size: 8pt;" >
        ...
        <tr>
           <td colspan="2">
               <font color="black"><strong>ADMINISTRATIVA:</strong></font><?php echo $rw_cliente['direccion_cliente']; ?>
...
while ($row=mysqli_fetch_array($sql))
    ...
    <BR>OBSERVACIONES:___________________________________________________________________________________________________
    <BR>___________________________________________________________________________________________________________________
    <BR>___________________________________________________________________________________________________________________
    <BR><STRONG>PERSONA QUE SOLICITA</STRONG>  
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <STRONG>PERSONA QUE RECIBE EL DESPACHO</STRONG>  
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
