...
while ($row=mysqli_fetch_array($sql))
	...
	$sumador_total+=$precio_total_r;//Sumador
        ...
        $insert_detail=mysqli_query($con, "INSERT INTO IngresosEgresos VALUES (NULL,'$id_cliente','$id_vendedor','$numero_factura','$des','$id_producto','$cantidad','','$cantidad','$precio_venta_r','$c','$ddd','1','$fecha2','$costo','$tipo','$d','$moneda1','$folio','','','$lote','$Ordencyp','')");
...
$insert=mysqli_query($con,"INSERT INTO facturas VALUES (NULL,'$numero_factura','$date','0','$nro_doc','$id_cliente','0','$id_vendedor','$condiciones','$sumador_total','$deuda','$tipo','$c','1','$ddd','1','$moneda1','$des','$obs','0','$fecha2','$dias','$folio','$des','','0','$motivo','$tip')");
...
//DIRECCION DE PDF
//print"$valor34";
header("location:ver_factura4.php?id_factura=$id_factura");
ob_end_flush();
?>