...
while ($row=mysqli_fetch_array($sql))
	...
	$sumador_total+=$precio_total_r;//Sumador
        ...
        $insert_detail=mysqli_query($con, "INSERT INTO tarjeta_responsabilidad VALUES (NULL,'$id_cliente','$id_vendedor','$numero_factura','$des','$id_producto','$cantidad','','$cantidad','$precio_venta_r','$c','$ddd','1','$fecha2','','$costo','$tipo','$d','$moneda1','$folio','','','$lote','$Ordencyp','')");
        //ACTUALIZAR STOCK PARA FACTURAS/BOLETA/NOTA DE CREDITO       
        //if($id_producto>0 and $tipo<>8){
            if($des==1){
                $productos1=mysqli_query($con, "UPDATE products SET descripcion='1' WHERE id_producto=$id_producto and pro_ser=1");
            }
        //}
        $nums++;
	//fin
