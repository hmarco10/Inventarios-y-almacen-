...
<table border="0" align="center" width="315px" style="font-size:15pt;color:black;">
    ...
    <tr>
        ...
        <td style="width:70%;"><strong><font size="2">DESCRIPCIÓN.</font></strong></td>
        <td align="right" style="width:15%;"><strong><font size="2">PRECIO.</font></strong></td>
    </tr>
    <tr>
      <td colspan="3">-----------------------------------------------------------------------------</td>
    </tr>
...
while ($row=mysqli_fetch_array($sql))
	...
	echo "<tr>";
        ...
        echo "<td align=center>".round($cantidad1,2)."</td>";
    ...
    <td align="right" colspan="2"><b>OP. GRAV <?php echo moneda;?>:</b></td>
    ...
    <td align="right" colspan="2"><b><?php echo nom_iva; ?> (<?php echo iva*100; ?>)% <?php echo moneda;?>:  </b></td>
    <td align="right"><b>
    <?php 
    if($tipo==0){
    ...
    <td align="right" colspan="2"><b>EXO <?php echo moneda;?>:</b></td>
    <td align="right"><b>  
    <?php 
    if($tipo==1){
    ...
    <td align="right" colspan="2"><b>INA <?php echo moneda;?>:</b></td>
    <td align="right"><b>  
    <?php 
    if($tipo==1){
        echo "0.00";
    ...
    <td align="right" colspan="2"><b>TOTAL <?php echo moneda;?>:</b></td>
    ...
    <tr>
    <td colspan="3" align="center"><?php echo $rw_factura['cod_hash'];?>
        <br><img src="qr/<?php echo $id_factura;?>.png" width="120" height="120"></td>
    
    </tr>
     <tr>
    
    <td colspan="3" align="center">Autorizado mediante Resolución de Intendencia N° 032-
    ...
    <tr>
      <td colspan="3"><br>Nº de artículos: <?php echo $suma ?></td>
    </tr>
    <tr>
      <td colspan="3">&nbsp;</td>
    </tr>      
    <tr>
        <td colspan="3" align="center"><strong><font size="3">¡Gracias por su compra, que Dios lo bendiga!</font></strong></td>
    </tr>
