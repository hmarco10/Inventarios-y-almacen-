...
while ($row=mysqli_fetch_array($sql))
	...
	$insert_detail=mysqli_query($con, "INSERT INTO IngresosEgresos VALUES (NULL,'$id_proveedores','$id_vendedor','$numero_factura','$ven_com','$id_producto','$cantidad','$cantidad','','$precio_venta_r','$c','1','2','$date_added','0','$tipo','$d','$moneda1','$folio','$cod','$renglon','','$detalle6','$detalle1')");
