...
while ($row=mysqli_fetch_array($sql))
	...
	$insert_detail=mysqli_query($con, "UPDATE IngresosEgresos set folio='$folio',numero_factura='$numero_factura',tipo_doc='$tipo' WHERE tienda=$tienda2 and folio='$folio1' and numero_factura='$num_fac' and tipo_doc=3 and ven_com=1");
