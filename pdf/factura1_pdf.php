...
while ($row=mysqli_fetch_array($sql))
	...
	$insert_detail=mysqli_query($con, "INSERT INTO IngresosEgresos VALUES (NULL,'$id_proveedores','$id_vendedor','$numero_factura','2','$id_producto','$cantidad','$precio_venta_r','$c','1','2','$date_added','0','$tipo','$d','$moneda1','$folio')");
...
$fecha1=date("Y-m-d", strtotime($fecha) );
$fecha2=date("y-m-d", strtotime($fecha_fac));
$date=$fecha1." ".$hora;
$date_added2=$fecha2." ".$hora;
$condiciones1="";
$cuenta="";
...
$insert=mysqli_query($con,"INSERT INTO facturas VALUES (NULL,'$numero_factura','$date_added2','0','','$id_proveedores','0','$id_vendedor','$condiciones','$sumador_total','$deuda','$tipo','$c','2','1','0','$moneda1','$cuenta','$obs','0','2018-01-01','$dias','$folio','2','','0','','0')");
