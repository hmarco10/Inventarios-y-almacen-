...
//CREAR CLIENTE NUEVO O EDITAR CLIENTE SI EXISTE  
    ...
    if($id_cliente==""){
        $sql="INSERT INTO clientes (nombre_cliente, telefono_cliente, email_cliente, direccion_cliente, status_cliente, date_added,doc,dni,vendedor,pais,departamento,provincia,distrito,cuenta,tipo1,tienda,users,deuda,debe) VALUES ('$nombre_cliente1','$tel1','$mail','$direccion','1','','$doc','$dni','','Guatemala','','','','','1','$tienda1','0','0','0')";
...
while ($row=mysqli_fetch_array($sql))
	...
	$insert_detail=mysqli_query($con, "INSERT INTO IngresosEgresos VALUES (NULL,'$id_cliente','$id_vendedor','$numero_factura','$des','$id_producto','$cantidad','$precio_venta_r','$c','1','1','$date_added','$costo','$tipo','$d','$moneda1','$folio')");
