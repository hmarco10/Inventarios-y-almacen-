...
url: "search_tarjetas_descargas.php",//la url adonde se va a mandar la cadena a buscar
data: dataString,
cache: false,
...
<body class="nav-md">
    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main">
		...
		?>  
                    ...
                    <h1 style="color:black; text-align:center; font-weight:bold">TARJETAS DE RESPONSABILIDAD CONSEJO NACIONAL DE ADOPCIONES</h1>
                    <div class="col-md-12 col-sm-7 col-xs-12" style=" background: white; ">
                            <table class="table">
                    ...
                    <div class="col-md-12 col-sm-5 col-xs-12" style="background:white;border-top:3px dotted yellow; border-bottom:3px dotted yellow; border-left:3px dotted yellow; border-right: 3px dotted yellow;">
                        ...
                        <div style="background:#A1A09F;padding:5px;margin:5px;border-radius: 7px;">
                            <?php 
                                ...
                                ?>
                            <font color="white" size="3"><strong>Tarjetas De Responsabilidad:</strong></font><font color="black">LLenar campos obligatorios</font> <font style="background-color:<?php echo COLOR1;?>;color:white; "> &nbsp;&nbsp;&nbsp;&nbsp;</font>                          
                        </div> 
            ...
            -->  
                        ...
                        <div class="form-group row" >
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12" style="width:100%;">
                                ...
                                <input  type="search" class="textfield11" autocomplete="off" class="form-control input-sm" style="background-color: white;" name="doc1" id="doc1"  placeholder="NIT Profesional"  value=""  required>
                            </div>
                        ...
                        <div class="form-group row" >
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <input class="textfield10"  type="search" minlength="10"  class="form-control input-sm" style="background-color: white;" name="nombre_cliente" id="nombre_cliente" placeholder="Nombre Profesional"  value=""   required>
                        ...
                        <div class="form-group row" >
                            <div class="col-md-6 col-sm-6 col-xs-12">
								...
								<input class="textfield10" type="text" autocomplete="off"  class="form-control input-sm" id="direccion_cliente" placeholder="Unidad" value="<?php echo $direccion;?>">
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                            Observacion:
                        ...
                        <div class="form-group row" >    
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12" style="width:50%;">
                                                           No. Tarjeta:
								              <input class="textfield10" type="text" autocomplete="off" class="form-control input-sm" id="mail" value="" placeholder="No. Tarjeta" >
                            </div>
                        </div>
  ...
  <script type="text/javascript" src="js/VentanaCentrada.js"></script>
	...
	$("#doc1" ).on( "keydown", function( event ) {
       ...
       //ESTA ES LA FUNCION QUE HACE EL AUTOCOMPLETE EN LA PANTALLA TARJETAS DE RESPONSABILIDAD                 
       $(function() {
						$("#nombre_cliente").autocomplete({
							source: "./ajax/autocomplete/buscarProfTarjetaDescargar.php",
							minLength: 1,
							select: function(event, ui) {
								event.preventDefault();
								$('#id_cliente').val(ui.item.id_cliente);
	...
	$("#nombre_cliente" ).on( "keydown", function( event ) {
	   ...
	   $(document).ready(function(){
			load(1);
                        $( "#resultados" ).load( "ajax/agregar_tarjeta_descarga.php" );
		});
	...
	function agregar (id)
	  {
        ...
        var stock=document.getElementById('stock_'+id).value;
			...
			$.ajax({
        type: "POST",
        url: "./ajax/agregar_tarjeta_descarga.php",
		...
		$("#resultados").html(datos);
            ...
            //ESTE ES EL QUE FUNCIONA PARA AGREGAR A agregar_tarjetas.php       
    function agregar2 (id)
          ...
          var estadoProducto=document.getElementById('estado_'+id).value;
          var profesional=document.getElementById('prof_'+id).value;
          //var profesional=document.getElementById('prof_'+id).value;
      //Inicia validacion
        ...
        type: "POST",
        url: "./ajax/agregar_tarjeta_descarga.php",
        data: "id="+id+"&precio_venta="+precio_venta+"&cantidad="+cantidad+"&stock="+stock+"&lote="+lote+"&estado="+estadoProducto+"&prof="+profesional,
		 beforeSend: function(objeto){
			$("#resultados").html("Mensaje: Cargando...");
		  },
        success: function(datos){
