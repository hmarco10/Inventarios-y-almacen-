...
<div class="display_box" align="left">
    <table style="color:black;" border="1">
     <tr style="background:#58FAD0;color:black;"><th style="width:5%;" align="center">Fotos</th><th style="width:20%;" align="center">Nombre</th><th style="width:50%;" align="center">Profesional</th><th style="width:25%;" align="center">Lote</th><th style="width:10%;" align="center">Stock</th><th style="width:10%;" align="center">Estado</th><th style="width:10%;">Cantidad</th><th style="width:10%;" align="center">Precio</th><th style="width:5%;"></th></tr>   
<?php
    
$sql_res=mysqli_query($con,"SELECT  * FROM products  inner join tarjeta_responsabilidad, clientes, users
WHERE products.id_producto=tarjeta_responsabilidad.id_producto and 
tarjeta_responsabilidad.id_cliente=clientes.id_cliente and clientes.documento=users.nit and products.descripcion=1
AND activo=1 AND nombre_producto like '%$q%' LIMIT 0 , 20");
...
//campos para traer profesional con bien asigando
$nombre_profesional=$row['nombres'];
//
...
?>
    ...
    <tr><td ><img src="fotos/<?php echo $foto?>" width="30" height="20" /></td>
        ...
        <!--td ><?php echo $lote; ?></td-->
        <td>
            <input type="text"  style="text-align:center;width:100%;" disabled id="prof_<?php echo $id; ?>" value="<?php echo $nombre_profesional;?>"> 
        </td>
        <td > 
