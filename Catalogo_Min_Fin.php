    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main">
		...
		<div class="panel-heading">
				...
				<button type='button' class="btn btn-info" data-toggle="modal" data-target="#nuevoProveedores"><span class="glyphicon glyphicon-plus" ></span> Nuevo Registro</button>
			</div>
                        <?php 
                                $video=videos;
                        ...
                        ?>
			<h4>Catálogo Ministerio de Finanzas Públiecas</h4>
		</div>
		<div class="panel-body">
		<?php
                include("modal/registro_cat_min_fin.php");
		include("modal/editar_cat_min_fin.php");
                ?>
...
<script>
		...
		function load(page){
			...
			$("#loader").fadeIn('slow');
			$.ajax({
				url:'./ajax/buscar_cat_min_fin.php?action=ajax&page='+page+'&q='+q,
		...
		$.ajax({
                type: "GET",
                url: "./ajax/buscar_cat_min_fin.php",
                data: "id="+id,"q":q,
		 beforeSend: function(objeto){
...
$('#guardar_datos').attr("disabled", true);
 var parametros = $(this).serialize();
	 $.ajax({
			type: "POST",
			url: "ajax/nuevo_cat_min_fin.php",
			data: parametros,
			 beforeSend: function(objeto){
...
$( "#editar_proveedores" ).submit(function( event ) {
 ...
 var parametros = $(this).serialize();
	 $.ajax({
			type: "POST",
			url: "ajax/editar_cat_min_fin.php",
			data: parametros,
			 beforeSend: function(objeto){
