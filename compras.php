    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main">
		...
		<div class="panel-heading">
				...
				<a  href="nueva_compras.php" class="btn btn-info"><span class="glyphicon glyphicon-plus" ></span> Nuevo Ingreso</a>
			</div>
                        <?php 
                                $video=videos;
                        ...
                        ?>
			<h4>Constancias De Ingresos a Inventarios y Almacén</h4>
		</div>
				...
				<form style="color:black;" class="form-horizontal" role="form" id="datos_cotizacion">
						...
						<div class="form-group row">
							...
							<div class="col-md-8 col-sm-8 col-xs-12">
                                                            Buscar Proveedor o # de Formulario 1h.
								<input type="text" class="form-control input-sm" id="q" placeholder="Nombre del Proveedor o # de Formulario 1h. " onkeyup='load(1);'>
							</div>
