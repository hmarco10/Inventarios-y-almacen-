...
<?php
	...
	if($action == 'ajax'){
		...
		$sWhere = "WHERE facturas.id_cliente=clientes.id_cliente and facturas.id_vendedor=users.user_id and facturas.ven_com=4 and facturas.activo=1";
		...
		if ($numrows>0){
			...
			?>
                        <a href="excel/buscar_pagos1.php?q=<?php echo $q;?>&q1=<?php echo $q1;?>&q2=<?php echo $q2;?>&q3=<?php echo $q3;?>" target="_blanck"><img src="images/descargar-excel.png" width="80" height="25"></a>
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<tr id="valor1">
                                            ...
                                            <td class=" ">
                                                 ...
                                                 <a href="#" class='btn btn-danger btn-xs' title='Borrar Pagos' onclick="eliminar('<?php echo $id; ?>')"><i class="glyphicon glyphicon-trash"></i> </a>
                                                 <a href="#" class='btn btn-primary btn-xs' title='Ver documentos pagados' onclick="imprimir_cobros('<?php echo $id;?>');"><i class="glyphicon glyphicon-download"></i></a> 
                                            </td>    
					</tr>
					<?php
                                }
