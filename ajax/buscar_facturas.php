...
<?php
	...
	if($action == 'ajax'){
		...
		$sWhere = "";
		$sWhere.=" WHERE facturas.id_cliente=clientes.id_cliente and facturas.tienda=$tienda1 and facturas.id_vendedor=users.user_id and facturas.ven_com=1 and facturas.estado_factura>=1 and facturas.estado_factura<=3 and facturas.activo=1 and facturas.numero_factura>0";
                if ( $_GET['q'] != "" )
		{
		$sWhere.= " and  (clientes.nombre_cliente like '%$q%' )";
                ...
                if ( $_GET['q1'] != "" )
		{
		$sWhere.= " and  (facturas.folio like '%$q1%' )";
		}
			...
			<div class="table-responsive">
			  <table class="table" style="color:black;">
				<tr  style="background-color:orange;color:black; ">
                                <th class='text-center'>No Despacho</th>
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<tr id="valor1">
						...
						<td class='text-justify'><?php echo $nombre_cliente;?></td>
                                                ...
                                                <td class='text-justify'><?php echo $nombre_vendedor; ?></td>
                                                ...
                                                <td class='text-center'><span class="label <?php echo $label_class;?>"><?php echo $text_estado; ?></span></td>
                                                 <td class='text-center'>
                                                     ...
                                                     <a href="pdf/documentos/ver_factura6.php?id_factura=<?php echo $id_factura;?>" class='btn btn-dark btn-xs' title='Descargar excel' ><i class="glyphicon glyphicon-download"></i></a> 
                                                     <!-- YA MANDA CORREO (y) -->
