...
<?php
	...
	if($action == 'ajax'){
		...
		$sWhere.=" order by clientes.debe desc";
			...
			<div class="table-responsive">
			  <table id="example" class="display nowrap" style="width:100%;color:black;">
				...
				<tr id="valor1">
                                    ...
                                    <td class="text-right">
					<a href="pagosproveedores.php?a=<?php echo $id_cliente;?>" class='btn btn-primary btn-xs' title='Descargar pagos' ><i class="glyphicon glyphicon-download"></i></a>
