				...
				while ($row=mysqli_fetch_array($query)){
					...
					<tr style="background-color: #81F7BE;color:black;">
						...
						<div class="pull-right">
                                                    <input type="text" class="form-control" style="text-align:center;" id="cantidad_<?php echo $id_producto; ?>">
						</div></td>
						<td class='col-xs-2'>
                                                    <div class="pull-right">
                                                        <input type="text" class="form-control"  style="text-align:center;" id="precio_venta_<?php echo $id_producto; ?>"  value="<?php echo str_replace(",","",number_format($precio_venta,2));?>">
                                                    </div>
                                                </td>
