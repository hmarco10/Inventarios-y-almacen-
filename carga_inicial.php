      ...
      <div class="right_col" role="main">
		...
		?>
                <div class="row" style='color:black;'>
                    ...
                    <div class="col-md-5 col-sm-5 col-xs-12" style=" border-top:3px dotted yellow; border-bottom:3px dotted yellow; border-left:3px dotted yellow; border-right: 3px dotted yellow; background: #f1f1f2">
			...
			<form method="post" class="form-horizontal" role="form" id="datos_factura" action="actualizar.php">
				 <div style="background:orange;padding:5px;margin:5px;border-radius: 7px;">
                            ...
                            <font color="BLACK" size="3"><strong>CARGA DE DATOS:</strong></font><!--font color="black">LLenar campos obligatorios</font> <font style="background-color:#D8D8D8;color:white; "> &nbsp;&nbsp;&nbsp;&nbsp;</font-->                          
                        </div> 
				  ...
				  <div class="col-md-12 col-sm-12 col-xs-12">
                                      <!--Proveedor-->
					  <input autocomplete="off" class="textfield10" type="hidden" style="margin-bottom: 20px; background-color: white" class="form-control input-sm" id="nombre_proveedores" placeholder="Selecciona un proveedor" value="<?php echo $nombre;?>" <?php echo $read;?> >
           ...
           <?php date_default_timezone_set('America/Lima');?>
            <table>
              ...
              <td style="width:200px;"> 
                ...
                <input class="form-control input-sm" style="float: left; width:80%;" class="textfield10" type="date" id="fecha" value="<?php echo date("Y-m-d");?>" required>
        ...
        <input 
          ...
          required autocomplete="off">                        
                                    ...
                                    <!--No Formulario 1H--><input class="textfield10" style="background-color:white;" type="hidden" class="form-control input-sm" id="serie" name="form-1h" placeholder="No Formulario 1H"  autocomplete="off">
                              ...
                              <div id="ocultar" class="col-md-6 col-sm-6 col-xs-12" style="width:50%">  
                                  <table>
                                    ...
                                    <tr>
                                      <td><input class="textfield10" style="background-color:white; width:90%;" type="number" min="1" class="form-control input-sm" name="factura" id="factura" placeholder="Número de Factura"  autocomplete="off"></td>
                                      <td><input  class="textfield10"  name="fecha1"  data-validate-length-range="4" type="date"  class="col-md-6 col-sm-6 col-xs-12" style="float: left; width:80%;" id="fecha1"   value="<?php echo $fecha1;?>" ></td>                                   
                                    </tr>
                                   </table>
                                </div>
                            ...
                            <div id="ocultar" class="form-group row">
                                <div class="col-md-6 col-sm-6 col-xs-12" style="width:50%">                        
                                    No. Serie Factura<input class="textfield10" style="background-color:white;" type="text" class="form-control input-sm" id="detalle1" placeholder="Serie Factura"  autocomplete="off">  
                                </div>
                                <div id="ocultar" class="col-md-6 col-sm-6 col-xs-12" style="width:50%">                          
                             ...
                             <div class="form-group row">
                                ...
                                <div id="ocultar" class="col-md-6 col-sm-6 col-xs-12" style="width:50%">                         
                                   Orden De C. Y P. No.<input class="textfield10" style="background-color:white;" type="text" class="form-control input-sm" name="detalle6" id="detalle6" placeholder="Orden C. Y P. No."  autocomplete="off"> 
                                </div>
                                <br>

                                <div id="ocultar" class="col-md-8 col-sm-6 col-xs-12">
                                  <br>
                                    <h5 style="font-weight:bold; color:black;">Seleccione los programas que necesite: </h5>
                                </div>
                                <br>
                                <div id="ocultar" class="col-md-6 col-sm-12 col-xs-6">
                                    <input  type="checkbox" name="checkbox[]" id="checkbox[]" value="ACTIVIDADES CENTRALES"> <strong>01.</strong> <br>
                                    <input  type="checkbox" name="checkbox[]" id="checkbox[]" value="RESTITUCION DE LOS DERECHOS DEL NNA"> <strong>11.</strong> <br>
                                    <input  type="checkbox" name="checkbox[]" id="checkbox[]" value="ASESORIA A MADRES Y/O PADRES BIOLOGICOS EN CONFLICTO CON SU PARENTALIDAD"><strong>12.</strong> <br>
                                    <input  type="checkbox" name="checkbox[]" id="checkbox[]" value="AUTORIZACION Y SUPERVISION DE HOGARES DE PROTECCION, ABRIGO Y CUIDADO DE NNA Y ORGANISMO INTERNACIONALES"><strong>13.</strong><br>                                                                                
                                </div>
        ...
        <div>
        <br>
        Observaciones <input class="textfield10" style="background-color:white;" type="text" class="form-control input-sm" id="detalle4" placeholder="Observaciones"  autocomplete="off">
        </div>                                    
                            </div>        
                            ...
                            <div>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <button type="submit" class="btn btn-primary">                                        
                                          <span class="glyphicon glyphicon-print"></span> CARGAR
                                    </button>
                                </div>  
                            </div>
		...
		<!-- Carga los datos ajax -->			
					...
					<div id="ocultar" class="pull-center">						
  ...
  <script>
	...
	function agregar (id)
		...
		$("#datos_factura").submit(function(){
		  ...
		  /* COMENTADO if (id_proveedores==""){
			  alert("Debes seleccionar un proveedor");
			  $("#nombre_proveedores").focus();
			  return false;
		  }*/
		 VentanaCentrada('./pdf/documentos/factura1_pdf.php?id_proveedores='+id_proveedores+'&id_vendedor='+id_vendedor+'&factura='+factura+'&moneda='+moneda+'&condiciones='+condiciones+'&fecha='+fecha+'&hora='+hora+'&dias='+dias+'&tcp='+tcp+'&serie='+serie+'&tipo_doc1='+tipo_doc1+'&obs='+obs+'&ven_com='+ven_com+'&detalle1='+detalle1+'&detalle2='+detalle2+'&detalle3='+detalle3+'&detalle4='+detalle4+'&detalle5='+detalle5+'&detalle6='+detalle6,'Factura','','1024','768','true');
	 	});
