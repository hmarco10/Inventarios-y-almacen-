    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main">
		...
		<div class="panel-heading">
				...
				<a  href="nueva_factura.php" class="btn btn-info"><span class="glyphicon glyphicon-plus" ></span> Nuevo Despacho</a>
			</div>
                        <?php 
                                $video=videos;
                        ...
                        ?>
			<h4>Lista de Despachos Consejo Nacional De Adopciones</h4>
		</div>
				...
				<form class="form-horizontal" style="color:black;" role="form" id="datos_cotizacion">
						...
						<div class="form-group row">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
                                                                Buscar Receptor de Unidad
								<input type="text" autocomplete="off" class="form-control input-sm" id="q" placeholder="Nombre del Profesional que recibe " onkeyup='load(1);'>
							</div>
