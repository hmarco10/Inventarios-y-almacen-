                   ...
                   <div class="col-md-12 col-sm-12 col-xs-12" >
                      ...
                      <div style="background:<?php echo COLOR;?>">       
                        ...
                        <div class="panel panel-info">
                           ...
                           <form style="color:black"  name="myForm" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="kardex3G300.php">
                      
                          
                      <div class="col-md-12 col-sm-12 col-xs-12" >
                          <label>Nombre del Producto:</label>
                        <input class="textfield10" type="search" style="color:black;font-size:10pt; font-family:Verdana;" class="form-control input-sm" id="nombre_producto" name="producto" value="" placeholder="Nombre del producto" >
...
?>
  ...
  <div class="table-responsive">
      <a href="kardex4G300.php?id_producto=<?php echo $id_producto;?>&fecha1=<?php echo $fecha1;?>&fecha2=<?php echo $fecha2;?>">Descargar</a>
...
//if($id_producto1==$id_producto  && $fecha>=$fech1 && $fecha<=$fech2 && $tienda>=$tienda1 && $tienda<=$tienda2){
        ...
        <tr id="valor1">
                       ...
                       if($entrada==0){
                           print"Despacho'$folio' No $numero_factura, $unidad_Profesional";
                       }else{
                           print"F.1H  '$folio' Factura $serie_fac No $numero_factura , $cliente1";
                       }
                       ...
                       ?>
                        ...
                        <td><?php echo number_format($pre1,6);?></td>
                        <td><?php echo $cp;$cp1=$cp1+$cp;?></td>
                        <td><?php echo number_format($q,6);?></td>
                      </tr>                
    <?php
    $s=$s+1;
  ...
  <script src="js/jquery-ui.js"></script>
		...
		$(function() {
						$("#nombre_producto").autocomplete({
							source: "./ajax/autocomplete/productosG300.php",
							minLength: 1,
